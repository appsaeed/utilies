 ...
 * @returns {string}
 */
export const uniqid = (prefix = '') => prefix + crypto.randomUUID();
/**
 * Generate random string
 * @param {number} len length of the string
 * @returns
 */
export function randomString(len = 10, prefix = '') {
 ...
 */
export function uuid(_length = null, prefix = null) {
    const _Length = _length ? _length : 36;
 ...
 * @returns
 */
export const uuidv1 = (_length = 36, prefix = "") => {
