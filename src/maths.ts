 ...
 * @returns {number}
 */
export function loanPerMonth(amount: number, interest: number, duration: number): number {
 ...
 * @returns {number}
 */
export function loanPerYear(amount: number, interest: number, duration: number): number {
 ...
 * @returns {number}
 */
export function loanPerday(amount: number, interest: number, duration: number): number {
